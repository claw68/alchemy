<div>
	<div style="padding-bottom: 15px;">
		<p style="font-weight: bold;">Add Max_price_index</p>
	</div>
	...
	<form onSubmit='return validate()' action="<?php echo site_url(); ?>max_price_index/doAdd" method="post" accept-charset="utf-8" enctype="multipart/form-data">
		<table>
			<tr>
